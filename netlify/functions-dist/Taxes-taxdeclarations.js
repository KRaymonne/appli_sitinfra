        ...
        switch (httpMethod) {
            ...
            case 'PUT':
                ...
                if (updateData.taxType !== undefined)
                    dataToUpdate.taxType = updateData.taxType;
                if (updateData.taxAmount !== undefined)
                    dataToUpdate.taxAmount = parseFloat(updateData.taxAmount);
                if (updateData.penalties !== undefined)
                    dataToUpdate.penalties = parseFloat(updateData.penalties);
                if (updateData.declarationDate !== undefined)
                    dataToUpdate.declarationDate = new Date(updateData.declarationDate);
