    ...
    try {
        switch (event.httpMethod) {
            ...
            case 'POST': {
                ...
                const { userId, visitDate, description, diagnosis, testsPerformed, testResults, prescribedAction, notes, nextVisitDate, medicalFile } = payload || {};
                // Basic validation
                const required = {
                    userId,
                    visitDate
            ...
            case 'PUT': {
                ...
                if (payload.testsPerformed !== undefined)
                    updateData.testsPerformed = payload.testsPerformed || null;
                if (payload.testResults !== undefined)
                    updateData.testResults = payload.testResults || null;
                if (payload.prescribedAction !== undefined)
                    updateData.prescribedAction = payload.prescribedAction || null;
                if (payload.notes !== undefined)
                    updateData.notes = payload.notes || null;
                if (payload.nextVisitDate !== undefined)
                    updateData.nextVisitDate = payload.nextVisitDate ? new Date(payload.nextVisitDate) : null;
                if (payload.medicalFile !== undefined)
                    updateData.medicalFile = payload.medicalFile || null;
