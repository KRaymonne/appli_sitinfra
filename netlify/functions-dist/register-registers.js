    ...
    try {
        switch (httpMethod) {
            ...
            case 'PUT':
                ...
                const dataToUpdate = {};
                if (updateData.registerName !== undefined)
                    dataToUpdate.registerName = updateData.registerName;
                if (updateData.location !== undefined)
                    dataToUpdate.location = updateData.location;
                if (updateData.responsiblename !== undefined)
                    dataToUpdate.responsiblename = updateData.responsiblename;
                if (updateData.userId !== undefined)
                    dataToUpdate.userId = updateData.userId ? parseInt(updateData.userId) : null;
                if (updateData.currentBalance !== undefined)
                    dataToUpdate.currentBalance = parseFloat(updateData.currentBalance);
                if (updateData.devise !== undefined)
                    dataToUpdate.devise = updateData.devise;
                if (updateData.attachmentfile !== undefined)
                    dataToUpdate.attachmentfile = updateData.attachmentfile;
