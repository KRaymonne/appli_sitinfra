        ...
        switch (httpMethod) {
            ...
            case 'PUT':
                ...
                if (updateData.client !== undefined)
                    dataToUpdate.client = updateData.client;
                // Handle contact field - convert to integer or null
                ...
                if (updateData.estimatedCost !== undefined)
                    dataToUpdate.estimatedCost = parseFloat(updateData.estimatedCost);
                if (updateData.salePrice !== undefined)
                    dataToUpdate.salePrice = parseFloat(updateData.salePrice);
                if (updateData.devise !== undefined)
                    dataToUpdate.devise = updateData.devise;
                if (updateData.comment !== undefined)
                    dataToUpdate.comment = updateData.comment || null;
                if (updateData.progress !== undefined)
                    dataToUpdate.progress = parseInt(updateData.progress);
