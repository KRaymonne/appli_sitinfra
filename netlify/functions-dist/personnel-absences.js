    ...
    try {
        switch (event.httpMethod) {
            ...
            case 'POST': {
                ...
                const { userId, absenceType, description, startDate, endDate, daysCount, returnDate, supportingDocument, Inserteridentity, InserterCountry } = payload || {};
                // Basic validation
                const required = {
                    userId,
                    absenceType,
            ...
            case 'PUT': {
                ...
                if (payload.absenceType)
                    updateData.absenceType = payload.absenceType;
                ...
                if (payload.daysCount !== undefined)
                    updateData.daysCount = Number(payload.daysCount);
                if (payload.returnDate)
                    updateData.returnDate = new Date(payload.returnDate);
